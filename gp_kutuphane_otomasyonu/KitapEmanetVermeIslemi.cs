...
namespace gp_kutuphane_otomasyonu
{
    public partial class frm_KitapVermeİslemi : Form
    {
        ...
        private void txt_ogrID_TextChanged(object sender, EventArgs e)// üye arama işlemi için kimlik numarasını girilerek öğrenciyi bulma
        {
        ...
        private void txt_kitap_id_TextChanged(object sender, EventArgs e)//kitap arama işlemi
        {
